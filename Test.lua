...
function Library:MakeWindow(WindowConfig)
        ...
        function TabFunction:MakeTab(TabConfig)
                ...
                local function GetElements(ItemParent)
                        ...
                        function ElementFunction:AddToggle(ToggleConfig)
                                ...
                                function Toggle:Set(Value)
                                        ...
                                        if Toggle.Value then
                                                -- ON: slide knob right, track turns white-ish
                                                ...
                                                -- OFF: slide knob left, track darker
                                                TweenService:Create(SwitchKnob, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                                                        Position = UDim2.new(0, 3, 0.5, 0),
                                                        BackgroundColor3 = Color3.fromRGB(200, 200, 200)
                                                }):Play()
                        ...
                        -- MULTI DROPDOWN: allows selecting multiple options at once
                        function ElementFunction:AddMultiDropdown(DropdownConfig)
                                ...
                                -- Copy in defaults that are valid options
                                ...
                                -- Gradient on multi dropdown frame
                                Create("UIGradient", {
                                        Color = ColorSequence.new({
                                                ColorSequenceKeypoint.new(0, Color3.fromRGB(28, 28, 28)),
                                                ColorSequenceKeypoint.new(1, Color3.fromRGB(20, 20, 20))
                                ...
                                local function AddOptions(Options)
                                        for _, Option in pairs(Options) do
                                                -- Each option has a mini switch-style checkbox
                                                local OptionBtn = AddThemeObject(SetProps(SetChildren(MakeElement("Button", Color3.fromRGB(40, 40, 40)), {
                                                        MakeElement("Corner", 0, 6),
                                                        AddThemeObject(SetProps(MakeElement("Label", Option, 13, 0.4), {
                                                                Position = UDim2.new(0, 8, 0, 0),
                        ...
                        -- Theme Picker: zeigt farbige Buttons für jedes Theme
                        function ElementFunction:AddThemePicker()
                                ...
                                -- Scrollable row of color buttons
                        ...
                        -- Font Picker: Dropdown zur Font-Auswahl
                ...
                function ElementFunction:AddSection(SectionConfig)
                        ...
                        -- Gradient on section accent bar
                        Create("UIGradient", {
                                Color = ColorSequence.new({
                                        ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
...
function Library:MakeNotifi(Configs)
        ...
        -- Gradient on notification timer bar
