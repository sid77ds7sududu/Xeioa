	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddToggle(ToggleConfig)
				...
				ToggleConfig.Color = ToggleConfig.Color or Color3.fromRGB(220, 220, 220)
				...
				function Toggle:Set(Value)
					Toggle.Value = Value
					TweenService:Create(ToggleBox, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Toggle.Value and Color3.fromRGB(255, 255, 255) or Library.Themes.Default.Divider, BackgroundTransparency = Toggle.Value and 0.05 or 0.5}):Play()
					TweenService:Create(ToggleBox.Stroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Color = Toggle.Value and Color3.fromRGB(255, 255, 255) or Library.Themes.Default.Stroke}):Play()
